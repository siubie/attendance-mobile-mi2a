<h1> Resume Pertemuan ke 5 </h1>

<h2> -- PART 1 -- </h2>

<h3>Parcel Shipping Courier </h3>

1 Membuat project Application Flutter 
...
3 Membuat folder Screens pada Folder Ui dan juga file pada folder Screen dengan nama Home Screen.dart dan tambahkan codenya
...
5 tambakan juga assets pada file pubspec.yaml untuk mengakses assetsnya 
...
2 Set pada android pada folder android/app/build.grade 

 ```yaml
  defaultConfig {
        // TODO: Specify your own unique Application ID (https://developer.android.com/studio/build/application-id.html).
        applicationId "com.example.parcel_shipping_courier"
        minSdkVersion 20
